...
export class OwlOdooServices extends Component {
    setup() {
        ...
        // to use default odoo layout display
        this.display = {
        ...
        this.state = useState({
            ...
            // for getting data from get request
            get_http_data: [],
            post_http_data: [],
            rpc_data: [],
            orm_data: [],
        ...
        titleService.setParts({zopenerp: "BiniScript", odoo: "Media", any:"Tutorials"})
    ...
    // this ORM service is directly connected with the database
    async getOrmService(){
    ...
    getActionService(){
        ...
        action.doAction({
            ...
            // in order to fileter the result
            //domain:[['display_name','ilike','biniyam']],
            domain:[],
            // in this context company ID name will be pass to the search area
